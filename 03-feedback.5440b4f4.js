...
const form = document.querySelector(".feedback-form"), email = document.querySelector("[type=email]"), message = document.querySelector("[name=message]");
function onLoad(e) {
    const formData = {
        email: email.value,
...
function formText() {
    ...
    if (saveData) {
        const parceSaveData = JSON.parse(localStorage.getItem("feedback-form-state"));
...
},{}]},["7Ih8d","eH52W"], "eH52W", "parcelRequireb7d1")
